 ...
 * sends and answers with the JSON shape `getResponseData` in `main.ts` expects.
 *
...
export default defineConfig(() => {
    return {
        plugins: [mkcert(), mockUploadEndpoint()],
        server: {
            // One port per demo: 5173 is react-demo, 5175 angular-demo,
