...
A minimal Vite + Vanilla TS app that integrates [`@scanupload/qr-code-generator-vanilla`](../../packages/vanilla) and [`@scanupload/qr-code-generator-uppy`](../../packages/uppy).
...
`build:vanilla` builds the core dependency and the Vanilla package, including the
