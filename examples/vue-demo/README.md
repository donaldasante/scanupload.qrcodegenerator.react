...
A minimal Vite + Vue 3 app that integrates
[`@scanupload/qr-code-generator-vue`](../../packages/vue) and
...
The app starts on https://localhost:5177 (HTTPS is required for the hub's
`Origin` checks).
