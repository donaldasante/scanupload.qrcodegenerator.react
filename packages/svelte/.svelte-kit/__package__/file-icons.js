import { createElement, File, FileText, FileImage, FileVideo, FileAudio, FileArchive, FileCode, FileSpreadsheet, FileType, FileDigit, FileJson, Presentation } from 'lucide';
/**
 ...
 */
export function getFileIconSvg(extension, size = 24) {
...
export function getGenericDocIconSvg(size = 24) {
    return renderIcon(File, size, '#6b7280');
}
